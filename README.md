...
* `git clone`ing it:
	...
	```
* or downloading the repository as a ZIP file and unzipping it with your favorite archive manager into `/some/path/Aircraft/c210-family` (make sure to remove the trailing `-master` from the directory name !)
